...
RUN chmod +x ps3netsrv_linuxX86_64 && chmod +x ps3netsrv2 && chmod +x startandmonitor && mkdir /games && apt-get update && apt-get install libcurl4-openssl-dev libjansson-dev
